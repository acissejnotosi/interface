...
public class corridaLivreActivity extends FragmentActivity implements
     ...
     * doubles
     */
    protected Double mLatitudeDouble;
    protected Double mLongitudeDouble;
    protected Double mAltitudeDouble;
    ...
    private final LatLng cordUTFPR = new LatLng(-25.439210,-49.269158);
   ...
   /* Vetor contendo dados de latitude*/
    protected Vector<Double> latVector;

    /*Vetor contendo dados de longitude*/
    protected Vector<Double> lngVector;

    /*Vetor contendo dados de altitude*/
    protected Vector<Double> altVector;

   /* Vetor contendo dados de velocidade entre dois pontos*/
    protected Vector<Float> speedVector;

    /* Vetor contendo dados de pulsação*/
    protected Vector<Integer> pulseVector;
    //************************************************************************************************
    /**
     * Inicio da Activity
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_corrida_livre);
    ...
    protected void constructMapDataVectors()
    {
        ...
        lngVector = new Vector<>();
        altVector = new Vector<>();
        speedVector = new Vector<>();
        pulseVector = new Vector<>();
    ...
    protected synchronized void buildGoogleApiClient() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .addConnectionCallbacks((GoogleApiClient.ConnectionCallbacks) corridaLivreActivity.this)
    ...
    private void updateUI() {
        ...
        mLatitudeDouble = mCurrentLocation.getLatitude();
        mLongitudeDouble = mCurrentLocation.getLongitude();
        mAltitudeDouble = mCurrentLocation.getAltitude();
        ...
        moveCamera(mLatitudeDouble, mLongitudeDouble);
        addNewMarkerRoute(mLatitudeDouble, mLongitudeDouble);

    }

    /**
     * Calcula a velocidade entre dois pontos de atualizaçao do GPS
     * Parâmetros de entrada: latIni-> latitude do ponto inicial
     *                        latFim-> latitude do ponto final
     *                        lngIni-> longitude do ponto inicial
     *                        lngFim-> longitude do ponto final
     */
    ...
    public void onMapReady(GoogleMap googleMap) {
      ...
      //mMap.moveCamera(CameraUpdateFactory.newLatLng(cordUTFPR));
        camera_position = new CameraPosition(cordCasaJessica,15, 0,0);
